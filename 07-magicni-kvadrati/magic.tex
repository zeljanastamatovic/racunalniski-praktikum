...
\newenvironment{dokaz}{\textit{Dokaz izreka.}}
...
Magični kvadrat v litografiji Melancholia I (glej sliko \ref{fig:sagrada}
...
približno 250 let pred Dürerjevim časom. \ref{fig:durer} % sklic: fig:durer
...
(glej sliko \ref{fig:sagrada} za fotografijo) vsebuje magični kvadrat reda 4. \ref{fig:sagrada}
% sklic: fig:sagrada
...
\begin{dokaz}
   ...
   enaka številu $M_2(n)$. \eqref{eq:numbers}\\% sklica: eq:numbers, eq:numbers
...
\cite{bessy}\cite{berlekamp}\cite{gardner}\cite{pinn}
