...
% Spodnja vrstica ne začne novega odstavka, zato ne bi smela biti zamaknjena.
% To popravite z ukazom `\noindent` ali pa tako, da odstranite prazno vrstico.
% (Nekrerefsdoliko lepše izgleda, če v prazno vrstico vstavite % za komentar.)
%
...
zato si je smiselno podrobneje ogledati posamezne korake.
   ...
   Za vse proste termine $\text{predavalnice}_{j}$ izračunamo ceno vstavljanja
   ...
   Ko preverimo vse proste termine vseh predavalnic, vstavimo $\text{srečanje}_{i}$
...
spremembo (npr. zamenjava srečanja$_{i}$ in $text{srečanja}_{j}$) sedaj shranimo v
seznam tabujev. V naslednjem koraku izvedemo spremembo $s_{2}$, ki se prav tako shrani v
